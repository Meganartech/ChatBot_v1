...
public class ChatBoxController {
    ...
    public ResponseEntity<String> getChatbox(@PathVariable String uniquePropertyId) {
        ...
        String type = property.getChatbotType().toString();
        ...
        if (chatboxHtml == null || chatboxHtml.isEmpty()) {
            LOGGER.warning("Error generating chatbox for Property ID: " + propertyId);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("<h3>Error generating chatbox</h3>");
        }
